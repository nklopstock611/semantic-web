...
After installing the required libraries, you can start by going into the `pdf-downloader` directory. There, you'll find four main python scripts:
- `main.py`: Run all the code in the correct order.
